...
@Entity //setting class is Entity database to JPA can manage data
@Table(name = "products") // setting name database
data class Product(
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY) // setting field is Primary Key and  Auto Increment
    var id: Int = 0,
